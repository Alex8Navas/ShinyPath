...
interfaz <- fluidPage(
  ...
  title =  h2(strong("Gutenberg"), align = "center"),
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      # Pestañas:
      tabsetPanel(id = "mytabsetpanel", type = "pills",
                  ...
                  tabPanel("Estudio",
                           ...
                           fluidRow(
                             ...
                             column(4, h4(strong("Total de Palabras")),
                                    h5(textOutput("totalwordsID"))), 
                             
                             column(4, h4(strong("Total de Palabras Únicas")),
                                    h5(textOutput("totaluniquewordsID"))), 
                             
                             column(4, h4(strong("Total de Especiales")),
                                    h5(textOutput("specialwordsID"))) 
                           ...
                           fluidRow(
                             ...
                             h3(strong("Nube de Palabras"), align = "Center"),
                  ...
                  tabPanel("Modificación",
                           ...
                           fluidRow(
                             ...
                             column(5, h4(strong("Comienzo del Libro")),
                                    h5(strong(textOutput("erste")))),
                             
                             column(5, h4(strong("Final del Libro")),
                                    h5(strong(textOutput("letze")))),
                  ...
                  tabPanel("Neues Buch",
                           ...
                           fluidRow(
                             ...
                             column(8, h5("Buenas, transeúnte. Escoge un fichero, escribe un título y selecciona el código."),
                                    h5("Pulsa primero 'Procesar' y, al aparecer la confirmación de que se ha procesado, da a 'Guardar'")),
                             
                             # Botón para procesar el texto. 
                             column(1, actionButton("processID", "Procesar fichero", 
                           ...
                           fluidRow(
                             ...
                             column(6, h3(strong("Características del Fichero"), align = "center"),
                                    ...
                                    hr(),
                                    h5(strong("Número Total de Líneas del Nuevo Libro:")), textOutput("neuesBuchLines"),
                                    h5(strong("Primera Línea del Nuevo Libro:")), textOutput("neuesBuchBeginning"),
                                    h5(strong("Última Línea del Nuevo Libro:")), textOutput("neuesBuchEnding")
                             ),
...
servidore <- function(input, output, session){
  ...
  output$totalwordsID <- renderText(totalWorte())
  
  output$totaluniquewordsID <- renderText(totaluniqueWorte())
  
  output$specialwordsID <- renderText(specialWorte())
  
  # ----- Pestaña Modificación -----
  
  output$erste <- renderText({
    
    if(is.null(input$erstetable_rows_selected)){
  ...
  output$letze <- renderText({
    
    if(is.null(input$letzetable_rows_selected)){
  ...
  output$erstetable <- renderDataTable({
    ...
    datatable(as.data.frame(vollstandig(), stringsAsFactor = FALSE), 
              ...
              options = list(searching = TRUE, # Con esto quitas (FALSE) o dejas (TRUE) el buscador de la tabla.
                             ...
                             pageLength = 10, # Filas mostradas por defecto. 
                             dom = "tiplf" 
  ...
  observeEvent(
    ...
    input$saveID,{
      ...
      write.csv(listaGutenberg, "data/Gutenbergv2.csv", row.names = FALSE)
  ...
  output$neuesBuchLines <- renderText({linesNeues()})
  output$neuesBuchBeginning <- renderText({anfangNeues()})
  output$neuesBuchEnding <- renderText({schliesslichNeues()})
