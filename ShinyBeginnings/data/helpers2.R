...
# Ajusta los datos de Yahoo Finance con los valores del índice delprecio al consumidor mensual precedente
# de los precios históricos de la Reserva Federal de St.Louis devueltos en los valores presentes.
